...
public class Stereotype extends OwnedMember {
	 ...
	 * LinkedHashSet (using this Collection to control the order which
	 * types are added to this stereotype).
	 * 
	 * @param name Name of the stereotype.
	 * @param id ID of the stereotype.
	 * @param visibility Visibility of the stereotype.
	 */
	 ...
	 * @param types Set of UML types which this stereotype can be associated.
	 */
	 ...
	 * 
	 * @param type UML type that can be associated with this stereotype.
	 */
