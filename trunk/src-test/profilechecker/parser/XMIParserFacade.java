...
public class XMIParserFacade {
	 ...
	 * @throws Exception If something fails.
	 */
	public String getProfileProperty(String profile, String property) throws Exception {
	 ...
	 * 
	 * @param profile Stereotype's profile ID.
	 * @param stereotype Stereotype ID.
	 * @param property Stereotype property.
	 * @return Stereotype property value.
	 * @throws Exception If something fails.
	 */
	public String getStereotypeProperty(String profile, String stereotype, String property) throws Exception {
